...
import com.example.homework.netflix.dto.FavoriteMovieResponse;
import com.example.homework.netflix.dto.GetUserFavoriteMovieRequest;
...
public class FavoriteMovieController extends AbstractController {
  ...
  public ResponseEntity<GetUserFavoriteMovieResponse> get(HttpServletRequest request) {
    ...
    log.info(String.format("get favorite movie for user {0}", user.getId()));
